...
const translations = {
  zh: {
    ...
    use_case_batch_title: "批量打开，提高工作效率。",
    use_case_batch_desc: "支持批量打开书签，一键打开多个标签页，提高工作效率。",
    ...
    step2_title: "创建标签",
    step2_desc: '进入主界面，在"书签管理"选项卡创建您的首个标签结构。',
    step3_title: "查看标签",
    step3_desc: '切换到"标签管理"选项卡，查看你刚刚添加的标签结构。',
    step4_title: "高效搜索",
  ...
  en: {
    ...
    use_case_batch_title: "Batch Opening for Efficiency",
    use_case_batch_desc: "Supports batch opening of bookmarks, opening multiple tabs with one click to improve work efficiency.",
